...
themes.view.Appearance = wp.Backbone.View.extend({
	...
	el: '#wpbody-content .wrap .tf-theme-browser',
...
themes.view.Details = wp.Backbone.View.extend({
	...
	html: themes.template( 'tf-theme-single' ),
...
themes.view.Themes = wp.Backbone.View.extend({
	...
	renderThemes: function( page ) {
		...
		if ( themes.data.settings.canInstall ) {
			this.$el.append( '<div class="theme add-new-theme"><a href="#" class="tf_lightbox_new" data-type="theme"><div class="theme-screenshot"><span></span></div><h3 class="theme-name">' + l10n.addNew + '</h3></a></div>' );
		}
...
themes.Router = Backbone.Router.extend({
	...
	routes: {
		'admin.php?page=tf-themes&theme=:slug': 'theme',
		'admin.php?page=tf-themes&search=:query': 'search',
		'admin.php?page=tf-themes&s=:query': 'search',
		'admin.php?page=tf-themes': 'themes',
		'': 'themes'
	},

	baseUrl: function( url ) {
		return 'admin.php?page=tf-themes' + url;
	},
...
themes.view.Installer = themes.view.Appearance.extend({
	...
	render: function() {
		...
		this.listenTo( this.collection, 'query:fail', function() {
			$( 'body' ).removeClass( 'loading-content' );
			$( '.theme-browser' ).find( 'div.error' ).remove();
			$( '.theme-browser' ).find( 'div.tf-themes' ).before( '<div class="error"><p>' + l10n.error + '</p></div>' );
		});
...
$( document ).ready(function() {
	...
	$( '.broken-themes .delete-theme' ).on( 'click', function() {
		return confirm( _tfThemeSettings.settings.confirmDelete );
	});
});
